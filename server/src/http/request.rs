...
use crate::http::util::EqualReader;
use crate::http::{HTTPVersion, Header, Method, Response, StatusCode};
...
pub struct Request {
    ...
    pub data_reader: Option<Box<Read + Send + 'static>>,

    // if this writer is empty, then the request has been answered
    pub response_writer: Option<Box<Write + Send + 'static>>,
...
impl Request {
    ...
    pub fn upgrade<R: Read>(
        ...
        use crate::http::util::CustomStream;
