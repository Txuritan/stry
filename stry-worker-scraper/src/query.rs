...
use {
    html5ever::{
        driver::ParseOpts, parse_document, serialize, tendril::TendrilSink,
        tree_builder::TreeBuilderOpts,
    },
    markup5ever::{serialize::TraversalScope, Attribute, QualName},
    markup5ever_arcdom::{ArcDom, Handle, NodeData, SerializableHandle},
    std::{cell::Ref, collections::HashMap, sync::Arc},
};
...
impl From<Arc<String>> for Document {
    fn from(input: Arc<String>) -> Self {
        Self::from(input.as_str())
    }
}
